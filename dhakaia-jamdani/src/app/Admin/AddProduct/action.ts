...
// Update Product <<
export const updateProduct = async (productData: FormData, productId: number) => {
  ...
  if (newImages.length > 0) {
    newImageUrls = await addProductImages(productData, existingProduct.image_bucket_path);
  }
